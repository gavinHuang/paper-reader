arXiv:2512.02589v1 [cs.AI] 2 Dec 2025
...
Junyi Hou, Andre Lin Huikai, Nuo Chen, Yiwei Gong, and Bingsheng He. 2018. PaperDebugger: A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing. In . ACM, New York, NY, USA, 4 pages. https://doi.org/XXXXXXX.XXXXXXX
...
Conference’17, Washington, DC, USA © 2018 Copyright held by the owner/author(s). Publication rights licensed to ACM. ACM ISBN 978-1-4503-XXXX-X/2018/06 https://doi.org/XXXXXXX.XXXXXXX
...
graph TB
    subgraph Presentation Layer
        ...
        B[Script Injector]
        C[Event Bridge]
        D[OAuth Landing Page]
    end
    
    subgraph Backend Layer
        E[gRPC Gateway]
        F[Auth]
        G[Manager Chat / Project / Agent]
        H[Pod Controller]
    end
...
<sup>1</sup>https://chromewebstore.google.com/detail/paperdebugger/
dfkedikhakpapbfcnbpmfhpklndgiaog
...
PaperDebugger: A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing        Conference'17, July 2017, Washington, DC, USA
...
```
72       \title{PaperDebugger: A Kubernetes-Native Agentic System for Integrated Academic
73       Writing Assistance
74
75
76                          PaperDebugger: Agentic Plugin for ...
77                            4 messages
78            Chat
79                               cking
80
81            Prompts                                 Diff  Copy    Insert
82
83            Settings
84
85                                PaperDebugger: A Kubernetes Plugin Native Agent
86                                Based Multi-Agent System for Integrated In-P
87                                lace Academic Writing Assistance, Review, and
88                                Editing
89
90                                           Diff  Copy    Insert
91
92                               Prompts     Actions                GPT-4.1
93
94                                Selected Text: PaperDebugger: A Kubernetes-Native Agen
95
96                               I think the current title isn't quite good enough, it failes
97
98            Paper              to highlight the most important selling points of this
99            Debugger           paper. From my perspective, the key selling point is
100
```
